...
<body>
    ...
    <div class="next-page" style="padding:0 50px;">
        ...
        <h2 style="background-color: lightgray; text-align: center; font-size: 14px;">TABLE OF CONTENT</h2>
        ...
        <p style="font-size: 11px; margin-top: 10px;">On an annualised basis, the investment has generated a compound
    ...
    <div class="next-page" style="padding:0 50px;">
        ...
        <table
            style="width: 70%; table-layout: fixed; font-size: 12px; border-collapse: collapse; border: 1px solid #000;">
            ...
            <tr>
                ...
                <td
                    style="border:none; border-bottom:1px solid #000; text-align:right; background-color: #FF0000; color: white;">
                    (1,3311,94)
                </td>
            </tr>
        </table>
